  ...
  form.addEventListener("submit", function (e) {
    ...
    fetch(form.action, {
      ...
      .catch(function () {
        ...
        msg.className = "f-msg ko";
        msg.innerHTML =
          'No hemos podido enviar el formulario. Llámenos al <a href="tel:+34600000000">600 00 00 00</a> o escriba a <a href="mailto:info@indemniza.me">info@indemniza.me</a>.';
      });
  });
})();
